...
import { GraduationCap, Eye, EyeOff, CheckCircle, AlertCircle, Lock, User } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-950 flex items-center justify-center p-6">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        ...
        <div className="bg-indigo-600 px-8 py-7 text-center">
          ...
          <p className="text-indigo-200 text-sm mt-1">Smart Campus — Complete your registration</p>
        </div>
          ...
          {phase === "success" && (
            <div className="text-center py-6 space-y-3">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Welcome to Smart Campus, <span className="font-medium">{name}</span>! Redirecting
                you to login…
              </p>
            </div>
          )}
          ...
          {phase === "form" && (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-900 rounded-lg px-4 py-3">
                <p className="text-xs text-blue-600 dark:text-blue-400 font-medium mb-0.5">Invited as</p>
                <p className="text-sm font-semibold text-blue-900 dark:text-blue-100">{inviteEmail}</p>
              </div>
