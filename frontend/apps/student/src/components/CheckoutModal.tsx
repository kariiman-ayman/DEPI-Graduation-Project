...
import { X, CreditCard, CheckCircle, Landmark, Banknote, Globe } from "lucide-react";
...
const METHODS: { id: PaymentMethod; label: string; icon: React.ElementType; desc: string }[] = [
  { id: "bank_transfer", label: "Bank Transfer", icon: Landmark, desc: "Transfer from your bank account" },
  { id: "online", label: "Online Payment", icon: Globe, desc: "Pay via online portal" },
  { id: "cash", label: "Cash Payment", icon: Banknote, desc: "Pay at the finance office" },
];
...
export default function CheckoutModal({
  ...
  const [result, setResult] = useState<{ transactionId: string; paidAt: string } | null>(null);
            ...
            <div className="text-center py-4">
              ...
              <div className="bg-gray-50 rounded-xl p-4 text-left mb-6 space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-mono text-gray-700 text-xs">{result.transactionId}</span>
                </div>
                <div className="flex justify-between text-sm">
